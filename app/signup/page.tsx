        ...
        <div className="auth-content-wrapper">
          ...
          <div className="auth-stats">
            <div className="auth-stat-item">
              <span className="auth-stat-number">
                <CountUp end={5248} />
              </span>
      ...
      <div className="auth-form-side">
        <div className="auth-form-wrapper">
          ...
          <div className="auth-form-tabs">
            <Link href="/signin" className="auth-tab">
              Sign In
            </Link>
            <Link href="/signup" className="auth-tab active">
              Sign Up
            </Link>
          </div>
          ...
          <div className="auth-social-buttons">
            <button className="auth-social-btn auth-google-btn">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z"/>
              </svg>
              Google
            </button>
            <button className="auth-social-btn auth-facebook-btn">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
